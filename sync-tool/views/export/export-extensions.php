...
<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('merge-extensions'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import" class="nav-tab"><?php echo __('Import', 'runway'); ?></a>
	<a href="<?php echo $this->self_url('merge-extensions'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export" class="nav-tab nav-tab-active"><?php echo __('Export', 'runway'); ?></a>
</div>
...
<div class="postbox">
	...
	<h3 class="hndle"><span><?php echo __('Local Extensions', 'runway'); ?></span></h3>
	<div class="inside" >
