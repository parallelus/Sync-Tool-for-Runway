...
<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('import-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=posts" class="nav-tab"><?php echo __('Import', 'framework'); ?></a>
	<a href="<?php echo $this->self_url('export-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=posts" class="nav-tab nav-tab-active"><?php echo __('Export', 'framework'); ?></a>
</div>
...
<div class="postbox">
	...
	<h3 class="hndle"><span><?php echo __('Local Posts', 'framework'); ?></span></h3>
	<div class="inside" >
		<a href="<?php echo $this->self_url('export-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export-all&what=posts" id="export-all-posts" class="add-new-h2"><?php echo __('Export All', 'framework'); ?></a><br/><br/>		
						...
						?>
							<tr class="active">
								...
								<td class="column-description desc">
									...
									<a href="<?php echo $this->self_url('export-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&item-id=<?php echo $i; ?>&what=posts" class=""><?php echo __('Export', 'framework'); ?></a>
									<?php else: ?>
