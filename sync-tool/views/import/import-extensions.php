<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('merge-extensions'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=extensions" class="nav-tab nav-tab-active"><?php echo __('Import', 'framework'); ?></a>
	<a href="<?php echo $this->self_url('merge-extensions'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=extensions" class="nav-tab"><?php echo __('Export', 'framework'); ?></a>
</div>
<?php 
...
<div class="postbox">
	...
	<h3 class="hndle"><span><?php echo __('Server Extension', 'framework'); ?></span></h3>
	<div class="inside" >		
