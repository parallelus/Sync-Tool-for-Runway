<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('import-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=users" class="nav-tab nav-tab-active"><?php echo __('Import', 'framework'); ?></a>
	<a href="<?php echo $this->self_url('export-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=users" class="nav-tab"><?php echo __('Export', 'framework'); ?></a>
</div>
<?php 
...
<div class="postbox">
	...
	<h3 class="hndle"><span><?php echo __('Server Users', 'framework'); ?></span></h3>
	<div class="inside" >
		<a href="<?php echo $this->self_url('import-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import-all&what=users" id="import-all-users" class="add-new-h2"><?php echo __('Import All', 'framework'); ?></a><br/><br/>
						...
						foreach ($server_users as $key => $value) {
							...
							?>
								<tr class="active">
									...
									<td class="column-description desc">
										<a href="<?php echo $this->self_url('import-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&item-id=<?php echo $i; ?>&what=users" class=""><?php echo __('Import', 'framework'); ?></a>
									</td>	
								</tr>
							<?php
							}
