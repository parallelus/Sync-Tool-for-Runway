<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('import-tags'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=tags" class="nav-tab nav-tab-active"><?php echo __('Import', 'runway'); ?></a>
	<a href="<?php echo $this->self_url('export-tags'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=tags" class="nav-tab"><?php echo __('Export', 'runway'); ?></a>
</div>
...
<div class="postbox">
	...
	<h3 class="hndle"><span><?php echo __('Server Tags', 'runway'); ?></span></h3>
	<div class="inside" >
		<a href="<?php echo $this->self_url('import-tags'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import-all&what=tags" id="import-all-tags" class="add-new-h2"><?php echo __('Import All', 'runway'); ?></a><br/><br/>
						...
						foreach ($server_tags as $key => $value) {
							...
							?>
								<tr class="active">
									...
									<td class="column-description desc">
										<a href="<?php echo $this->self_url('import-tags'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&item-id=<?php echo $i; ?>&what=tags" class=""><?php echo __('Import', 'runway'); ?></a>
									</td>
								</tr>
							<?php
							}
